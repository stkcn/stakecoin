...
{
    return GetBoolArg("-testnet", false) ? 18345 : 19875;
}
...
Value stop(const Array& params, bool fHelp)
{
    if (fHelp || params.size() > 1)
        throw runtime_error(
            ...
            "Stop StakeCoin server (and possibly override the detachdb config value).");
...
void ThreadRPCServer(void* parg)
{
    ...
    RenameThread("StakeCoin-rpclist");
...
void ThreadRPCServer3(void* parg)
{
    ...
    RenameThread("StakeCoin-rpchand");
