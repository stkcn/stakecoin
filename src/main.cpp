...
unsigned int nStakeMinAge = 7 * nOneHour; // as zero time weight
...
void ThreadScriptCheck(void*) {
    ...
    RenameThread("StakeCoin-scriptch");
...
bool CBlock::ConnectBlock(CTxDB& txdb, CBlockIndex* pindex, bool fJustCheck)
{
    ...
    bool fEnforceBIP30 = true; // Always active in StakeCoin
...
bool CBlock::CheckBlock(bool fCheckPOW, bool fCheckMerkleRoot, bool fCheckSig) const
{
    ...
    if (fProofOfStake)
    {
        ...
        // StakeCoin: check proof-of-stake block signature
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "StakeCoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "stakecoin genesis";
        CTransaction txNew;
        txNew.nTime = 1493054702;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1493054702;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = !fTestNet ? 557796 : 99999999;
       ...
       if (fTestNet) {
        ...
        //// debug print
        assert(block.hashMerkleRoot == uint256("0x1e440cb5d73eb87de542d52799c1792b0ccc6ea875dda4f0a8d658800b3fe6f9"));
        if (!fTestNet){
...
unsigned char pchMessageStart[4] = { 0xb8, 0xf8, 0xe2, 0xe5 };
