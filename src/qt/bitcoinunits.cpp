...
QString BitcoinUnits::name(int unit)
{
    switch(unit)
    {
    case BTC: return QString("STCN");
    case mBTC: return QString("mSTCN");
    case uBTC: return QString::fromUtf8("μSTCN");
...
QString BitcoinUnits::description(int unit)
{
    switch(unit)
    {
    case BTC: return QString(QObject::tr("StakeCoins"));
    case mBTC: return QString(QObject::tr("Milli-StakeCoins (1 / 1,000)"));
    case uBTC: return QString(QObject::tr("Micro-StakeCoins (1 / 1,000,000)"));
    default: return QString("???");
    }
}
